...
from ops import conv_layer, bottleneck_block, avg_pool, flatten_layer, fc_layer, dropout
...
def create_network(X, h, keep_prob, numClasses):
    ...
    with tf.variable_scope('Res2'):
        res2a = bottleneck_block(res1, block_name='res2a',
        ...
        print('---------------------')
        res2b = bottleneck_block(res2a, block_name='res2b',
        ...
        print('---------------------')
        res2c = bottleneck_block(res2b, block_name='res2c',
    ...
    with tf.variable_scope('Res3'):
        res3a = bottleneck_block(res2c, block_name='res3a',
        ...
        print('---------------------')
        res3b = bottleneck_block(res3a, block_name='res3b',
        ...
        print('---------------------')
        res3c = bottleneck_block(res3b, block_name='res3c',
        ...
        print('---------------------')
        res3d = bottleneck_block(res3c, block_name='res3d',
    ...
    with tf.variable_scope('Res4'):
        res4a = bottleneck_block(res3d, block_name='res4a',
        ...
        print('---------------------')
        res4b = bottleneck_block(res4a, block_name='res4b',
        ...
        print('---------------------')
        res4c = bottleneck_block(res4b, block_name='res4c',
        ...
        print('---------------------')
        res4d = bottleneck_block(res4c, block_name='res4d',
        ...
        print('---------------------')
        res4e = bottleneck_block(res4d, block_name='res4e',
        ...
        print('---------------------')
        res4f = bottleneck_block(res4e, block_name='res4f',
    ...
    with tf.variable_scope('Res5'):
        res5a = bottleneck_block(res4f, block_name='res5a',
        ...
        print('---------------------')
        res5b = bottleneck_block(res5a, block_name='res5b',
        ...
        print('---------------------')
        res5c = bottleneck_block(res5b, block_name='res5c',
